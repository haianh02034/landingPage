...
import PhoneNumberValidation from '../../service/PhoneNumber/PhoneNumberValidation';
const UserForm = () => {
...
<div className="t:max-w-full text-white xl:px-4 xl:container xl:max-w-screen-xl container">
  ...
  style={{
    ...
    minWidth: '320px',
    minHeight: '270px',
    margin: '10% 3rem 5rem', // Căn giữa ngang theo chiều rộng
    order: 1,
  }}
